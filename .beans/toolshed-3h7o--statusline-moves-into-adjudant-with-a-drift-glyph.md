...
updated_at: 2026-09-11T04:28:02Z
...
- [ ] copy both scripts into `adjudant/statusline/`, fix the tokens-24h path to `dirname BASH_SOURCE`
- [ ] `shim.sh` + `install.sh`; session-start writes `~/.claude/adjudant-statusline-path`
- [ ] S1 drift glyph: main checkout off main; `feature/<id>` on a completed/scrapped bean; in-progress feature with no branch
- [ ] `test_statusline.py`
- [ ] `reference/state-contract.md`, `reference/internals.md`, README, GUIDE, toolshed AGENTS.md
